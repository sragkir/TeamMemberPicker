...
This solution gives the ability to select Single User or Multiple users from the people picker. It works on the _**User(systemuser)**_ table or _**AAD User(aaduser)**_ table or _**team(teammembership)**_ table of the dataverse.
...
# Control Features:
  ...
  •	_This control will access users from "AAD User" Table or "User" table or teammembership table to get specific AD group users._
